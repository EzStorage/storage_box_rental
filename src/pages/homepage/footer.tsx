    ...
    >
      ...
      >
        ...
        <Box sx={{ flex: "200px", display: "flex", alignItems: "up"}}>
          <Logo />
          <FooterTitle style={{fontSize:"1.5rem",paddingTop:"5px"}}>Storage</FooterTitle>
        </Box>
        ...
        <Box sx={{ flex: "1 1 200px" }}>
          ...
          <FooterText style={{fontSize:"15px",lineHeight:"20px"}}>Customer Support Hours</FooterText>
          <FooterText style={{fontWeight:400,marginBottom:"20px"}}>Mon to Fri: 9:30 AM - 5:00 PM</FooterText>
          <FooterText style={{fontSize:"15px",lineHeight:"20px"}}>Delivery Hours</FooterText>
          <FooterText style={{fontWeight:400}}>Mon to Fri: 9:30 AM - 5:00 PM</FooterText>
