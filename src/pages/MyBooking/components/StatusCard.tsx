...
import { BoxDetailsRow, PaperCard, StatusBanner, StatusText, BoxImageStyled, BoxTitle, BoxSubText } from "../styles";
    ...
    <PaperCard>
      <StatusBanner sx={{ backgroundColor }}>
        ...
        <StatusText sx={{ color: textColor }}>
          {booking.status === BookingStatus.Stored ? "Your inventory has been stored" : booking.status}
        </StatusText>
      </StatusBanner>
      <BoxDetailsRow>
